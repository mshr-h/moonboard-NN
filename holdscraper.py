...
def main():
	...
	names = np.load('./names.npy')       # numpy array containing list of problem names

	i=9000
	while i < range(len(names)):
		matrixfile = open('./matrices.txt', 'ab')
		gradefile  = open('./grades.txt',   'ab')
